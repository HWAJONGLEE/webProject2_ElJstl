...
function moveUpdateView(){
	...
	location.href = "/testel/mupview?userid=${ requestScope.member.userid }";
}
...
function sendDelete(){
	...
	location.href = "/testel/mdel?userid=${ requestScope.member.userid }";
}
</script>
</head>
<body>
...
<tr>
	<th>암 호</th>
	<td>${ requestScope.member.userpwd }</td>
</tr>
<tr>
	<th>성 별</th>
...
<tr>
	<th>취 미</th>
	<td>${ requestScope.member.hobby }	</td>
</tr>
<tr>
	<th>하고싶은 말</th>
	<td>${ requestScope.member.etc }</td>
</tr>
<tr>
	<th colspan="2">
